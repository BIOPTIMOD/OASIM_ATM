...
module yaml_oasim_types
   use oasim_common, only: string_length, real_kind
        
   implicit none

   private

   public type_node,type_scalar,type_null,type_error
   public type_dictionary,type_key_value_pair
   public type_list,type_list_item

   ! integer,parameter :: string_length = oasim_string_length
   ! integer,parameter :: real_kind = oasim_real_kind
