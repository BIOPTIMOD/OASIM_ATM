...
s_cdom   = 0.025  #for the Adriatic s_cdom = 0.0192 ; Dutkiewicz: s_cdom = 0.021 
...
#    print(mystring)
print("CDOM c-specific absorption")
print("Computed in optimization phase CMEMS")
print("# S_350_500 = 0.025/0.025/0.025 nm-1")
print("# a_cdom at 440nm = 0.18 m2 mmolC-1")
print("# average of the integral in the waveband")
print("Format I5,1E10.2")
for i in range(len(lam)-1):
    mystring ="{:5d}".format(int(lam[i])) + '  '+ "%.6E" % (acdom_bin[i]/12.)  + '  ' + "%.6E" % (acdom_bin[i]/12.) + '  ' + "%.6E" % (acdom_bin[i]/12.)
    print(mystring)
