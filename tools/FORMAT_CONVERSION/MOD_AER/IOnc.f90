...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       SUBROUTINE WRITE_AVE_2D(fileNetCDF, VAR1, VAR2, VAR3, datefrom, dateTo, M1, M2, M3)
       USE netcdf
       IMPLICIT NONE
       ...
       real,intent(in),dimension(jpiglo, jpjglo, nlt) :: M1, M2, M3

       character(LEN=20) :: VAR1, VAR2, VAR3
       integer :: istart,iend

       integer :: ji,jj
       integer :: s, nc, counter
       integer :: timid, yid, xid, nid
       integer :: idvartime, idphit, idlamt, idVAR1, idVAR2, idVAR3
       ...
       REAL :: totglamt(jpiglo,jpjglo),  totgphit(jpiglo,jpjglo)
        ...
        s = nf90_def_var(nc,trim(VAR3) ,        nf90_float, (/xid,yid,nid/),  idVAR3)
        ...
        s = nf90_put_att(nc,idVAR1, 'missing_value' ,-9999)

        s = nf90_put_att(nc,idVAR2, 'long_name'    ,trim(VAR2))
        s = nf90_put_att(nc,idVAR2, 'missing_value' ,-9999)

        s = nf90_put_att(nc,idVAR3, 'long_name'    ,trim(VAR3))
        s = nf90_put_att(nc,idVAR3, 'missing_value' ,-9999)
