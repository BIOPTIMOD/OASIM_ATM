...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       SUBROUTINE WRITE_AVE_2D(fileNetCDF, VAR1, VAR2, VAR3, VAR4, datefrom, dateTo, M1, M2, M3, M4)
       USE netcdf
       IMPLICIT NONE
       ...
       real,intent(in),dimension(jpiglo, jpjglo, ntime) :: M1, M2, M3, M4
       ...
       integer :: idvartime, idphit, idlamt, idVAR1, idVAR2, idVAR3, idVAR4
